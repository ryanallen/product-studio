---
name: updater
description: Updates Figma token (update-figma), commits (save), syncs upstream (sync-upstream). Use when user says save, sync, sync upstream, update figma, /save, /sync-upstream, /update-figma.
