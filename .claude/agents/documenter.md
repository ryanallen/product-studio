...
Scope: Only the document, document-paths, document-agent, and document-skills skills. For README work, also use document-github, document-voice, and document-enhance. Write to project README at the path from work/paths.md. When doing documentation work, use subagents per the document-agent skill.
...
5. When creating or updating a README, also follow [document-github](../skills/document-github/SKILL.md), [document-voice](../skills/document-voice/SKILL.md), and [document-enhance](../skills/document-enhance/SKILL.md).
