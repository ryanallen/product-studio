---
name: document-business-plan
description: Write, structure, and update a business plan for a solopreneur. Use when creating a plan from scratch, updating an existing plan after a pivot or new phase, or preparing a plan to share with investors, partners, or to clarify your own strategy. Covers executive summary, market analysis, competitive positioning, revenue model, operations plan, financial projections, and risk assessment — all adapted for a one-person business. Trigger on "write a business plan", "business plan", "create my plan", "business plan template", "update my business plan", "plan for my business", "investor pitch plan".
...
**Output in this project:** One main doc per plan (path from [work/paths.md](work/paths.md)). Use the project's README as the plan, or a single doc in that project's `references/` (e.g. `business-plan.md`) and link from the README. Apply [document-voice](.claude/skills/document-voice/SKILL.md): clear, casual, no jargon.
